...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pat Wright Roofing — Dublin Roofing Experts" },
      { property: "og:description", content: "Trusted roofing services across Dublin. 4.7★ on Google. Free quotes, 24/7 emergency response." },
